            ...
            if (level >= 4) {
                ...
                switch (level) {
                    ...
                    case (3):
                        hit = 6;
                        miss = 2;
                        text = "In this section, you will be asked to select one item from one of three menus for each task. The next task will display immediately after you successfully choose the correct item. You will have a chance to practice before you begin the test. This is a practice session. You will finish "+practiceTrialNum+" trials.";
                        break
                    case (4):
                        hit = 40;
                        miss = 10;
